  ...
  return (
    <>
      ...
      <AdminOperationsLayout
        ...
        description="Platform-level provider token capacity, spend, quota plans, and refill/renewal monitoring. Candidate-facing balances use Credits / Attempts / Unlimited only — this is the only surface where raw provider tokens appear. See docs/AI-USAGE-POLICY.md."
        breadcrumbs={[
