...
const expertNavigation: OetNavigationItem[] = [
  {
    ...
    path: "/reviewer/queue",
    children: [
      { name: "Queue", path: "/reviewer/queue" },
      { name: "Calibration", path: "/reviewer/calibration" },
      { name: "Metrics", path: "/reviewer/metrics" },
      { name: "Schedule", path: "/reviewer/schedule" },
    ],
  },
];
...
const adminNavigation: OetNavigationItem[] = [
  {
    ...
    path: "/cms/content",
    children: [
      { name: "Content Library", path: "/cms/content" },
      { name: "Task Builder", path: "/cms/content/new" },
      { name: "Taxonomy", path: "/cms/taxonomy" },
      { name: "Target Countries", path: "/cms/taxonomy/countries" },
      { name: "Exam Types", path: "/cms/taxonomy/exams" },
      { name: "Professions", path: "/cms/taxonomy/professions" },
      { name: "Sessions", path: "/cms/taxonomy/sessions" },
    ],
  },
  {
    type: "dropdown",
    ...
    path: "/cms/criteria",
    children: [
      { name: "Criteria", path: "/cms/criteria" },
      { name: "AI Config", path: "/cms/ai-config" },
      { name: "Review Ops", path: "/cms/review-ops" },
      { name: "Quality Analytics", path: "/cms/analytics/quality" },
      { name: "User Ops", path: "/cms/users" },
      { name: "Billing Ops", path: "/cms/billing" },
      { name: "Feature Flags", path: "/cms/flags" },
      { name: "Audit Logs", path: "/cms/audit-logs" },
    ],
  },
];
