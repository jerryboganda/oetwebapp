...
import { AdminRouteSummaryCard } from '@/components/domain/admin-route-surface';
...
export default function AdminVocabularyImportPage() {
  ...
  return (
    <>
      ...
      >
        <SettingsSection title="Upload &amp; preview">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <label className="flex min-w-64 flex-col gap-1 text-xs font-medium text-admin-fg-muted">
                Import batch ID
                <input
                  value={importBatchId}
            ...
            <div className="rounded-2xl border border-border bg-background-light/70 p-4">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <label className="flex min-w-64 flex-1 flex-col gap-1 text-xs font-medium text-admin-fg-muted">
