...
| P3-3 | Writing rulebook drills only populated for the medicine profession. Other 12 professions have empty drill banks. | `rulebooks/writing/drills/medicine/**` only. | ✅ **RESOLVED 2026-05-13.** `lib/writing-drills/loader.ts` now registers medicine seeds, all non-medicine abbreviation seeds, and generated profession-specific relevance/opening/ordering/expansion/tone drills. `lib/writing-drills/__tests__/loader.test.ts` locks all 12 professions x 6 drill types. |
