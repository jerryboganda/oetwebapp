...
public partial class LearnerService(
    ...
    global::OetWithDrHesham.Api.Services.IWritingEntitlementService? writingEntitlement = null,
    OetWithDrHesham.Api.Services.Mocks.Results.IMockReportAggregationService? mockReportAggregation = null,
    SpacedRepetitionService? spacedRepetition = null,
    GamificationService? gamification = null,
    OetWithDrHesham.Api.Services.Planner.ContentPicker? studyPlanContentPicker = null,
    OetWithDrHesham.Api.Services.Readiness.ReadinessComputationService? readinessComputation = null,
    OetWithDrHesham.Api.Services.Billing.ICouponVariantApplicator? couponVariantApplicator = null,
    ...
    ILogger<LearnerService>? logger = null)
{
    ...
    {
        var goal = await db.Goals.FirstOrDefaultAsync(g => g.UserId == userId, ct);
        var examType = OetWithDrHesham.Api.Services.Common.ExamCodes.NormalizeOrNull(goal?.ExamTypeCode) ?? OetWithDrHesham.Api.Services.Common.ExamCodes.DefaultCode;
