---
name: "Awesome frontend-performance-investigator"
...
- Producing a prioritized remediation plan instead of generic â€œoptimize performanceâ€ advice
...
- â€œInvestigate why the dashboard feels slow on first load.â€
- â€œUse DevTools to diagnose our CLS regression on mobile.â€
- â€œFind the bottleneck causing poor INP after opening the filter drawer.â€
- â€œAnalyze this route and tell me which fixes will move LCP the most.â€
