---
name: "Awesome neo4j-docker-client-generator"
...
â”œâ”€â”€ models.py            # Pydantic data classes
â”œâ”€â”€ repository.py        # Repository pattern for queries
...
â””â”€â”€ test_repository.py   # Basic integration tests
...
- âœ… Repository pattern for query organization
- âœ… Type hints everywhere
- âœ… Basic error handling
- âœ… Context managers for connections
- âœ… Parameterized Cypher queries
- âœ… Working pytest tests with testcontainers
- âœ… Clear README with examples

**What to AVOID:**
- âŒ Complex transaction management
- âŒ Async/await (unless explicitly requested)
- âŒ ORM-like abstractions
- âŒ Logging frameworks
- âŒ Monitoring/observability code
- âŒ CLI tools
- âŒ Complex retry/circuit breaker logic
- âŒ Caching layers
