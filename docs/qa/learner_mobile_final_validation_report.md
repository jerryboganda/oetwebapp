# Learner Mobile Final Validation Report
...
- If release packaging is required, perform a signed build as the next release step.
...
- [android/](../../android)
- [ios/](../../ios) contains the native iOS project.
