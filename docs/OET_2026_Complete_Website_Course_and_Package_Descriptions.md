---
title: "OET 2026 Website Course & Package Descriptions"
organization: "OET with Dr. Ahmed Hesham"
year: 2026
source_documents:
  - "OET_2026_Website_Course_Package_Descriptions_UPDATED (1).pdf"
  - "OET_2026_Website_Course_Package_Descriptions_UPDATED_WITH_AI_PACKAGES (1).pdf"
---

# OET 2026

## Website Course & Package Descriptions

Description-only copy for the website catalogue and product detail pages

*Ready-to-use description copy for course cards and product detail pages.*

**OET with Dr. Ahmed Hesham**

support@oetwithdrhesham.co.uk | app.oetwithdrhesham.co.uk
...
## Full Recorded Courses

- [Full Condensed Recorded OET Course - Medicine](#1-full-condensed-recorded-oet-course-medicine)
- [Full Physiotherapy OET Course](#2-full-physiotherapy-oet-course)
- [Full Allied Health Profession OET Course](#3-full-allied-health-profession-oet-course)
- [Full Condensed Recorded Course + TutorBook](#4-full-condensed-recorded-course-tutorbook)
- [Full Nursing OET Course](#5-full-nursing-oet-course)
- [Nursing Course + Assessment Package](#6-nursing-course-assessment-package)
- [Nursing Premium Bundle](#7-nursing-premium-bundle)
- [Full Pharmacy OET Course](#8-full-pharmacy-oet-course)
- [Basic English Course - Preparation for OET](#9-basic-english-course-preparation-for-oet)
- [Full Crash Course - General OET](#10-full-crash-course-general-oet)
- [Full Crash Course + 3 Writing Assessments](#11-full-crash-course-3-writing-assessments)
- [Full Crash Course + 5 Writing Assessments](#12-full-crash-course-5-writing-assessments)

## Separate Writing, Speaking & Combo Packages

- [3 Writing Letter Assessments - Add-on](#13-3-writing-letter-assessments-add-on)
- [5 Writing Letter Assessments - Add-on](#14-5-writing-letter-assessments-add-on)
- [7 Writing Letter Assessments - Add-on](#15-7-writing-letter-assessments-add-on)
- [10 Writing Letter Assessments - Add-on](#16-10-writing-letter-assessments-add-on)
- [Recorded Writing Crash Course](#17-recorded-writing-crash-course)
- [Writing Crash Course + 2 Letter Assessments](#18-writing-crash-course-2-letter-assessments)
- [Writing Crash Course + 3 Letter Assessments](#19-writing-crash-course-3-letter-assessments)
- [Writing Crash Course + 5 Letter Assessments](#20-writing-crash-course-5-letter-assessments)
- [Writing Crash Course + 7 Letter Assessments](#21-writing-crash-course-7-letter-assessments)
- [Writing Crash Course + 10 Letter Assessments](#22-writing-crash-course-10-letter-assessments)
- [Recorded Speaking Crash Course](#23-recorded-speaking-crash-course)
- [1 Private Speaking Assessment Session](#24-1-private-speaking-assessment-session)
...
- [TutorBook - First Edition 2026](#28-tutorbook-first-edition-2026)
- [TutorBook - Add-on for Enrolled Students](#29-tutorbook-add-on-for-enrolled-students)

## AI Credits, Practice & Mock Exam Packages

### AI Grading Packages

- [Quick Check](#30-quick-check)
- [Exam Prep Pro](#31-exam-prep-pro)
- [OET Mastery](#32-oet-mastery)
### Full Mock Exam Packages

- [1 Full Mock](#33-1-full-mock)
- [3 Full Mocks](#34-3-full-mocks)
- [5 Full Mocks](#35-5-full-mocks)
### Separate Listening Packages

- [Listening Starter](#36-listening-starter)
- [Listening Standard](#37-listening-standard)
- [Listening Pro](#38-listening-pro)
### Separate Reading Packages

- [Reading Starter](#39-reading-starter)
- [Reading Standard](#40-reading-standard)
- [Reading Pro](#41-reading-pro)
### Separate Writing Packages

- [Writing Starter](#42-writing-starter)
- [Writing Standard](#43-writing-standard)
- [Writing Pro](#44-writing-pro)
### Separate Speaking Packages

- [Speaking Starter](#45-speaking-starter)
- [Speaking Standard](#46-speaking-standard)
- [Speaking Pro](#47-speaking-pro)

---

# Full Recorded Courses

### 1. Full Condensed Recorded OET Course - Medicine
...
<!-- Original source page(s): 2, 3 -->

### 2. Full Physiotherapy OET Course
...
<!-- Original source page(s): 3 -->

### 3. Full Allied Health Profession OET Course
...
### 4. Full Condensed Recorded Course + TutorBook
...
<!-- Original source page(s): 3, 4 -->

### 5. Full Nursing OET Course
...
<!-- Original source page(s): 4 -->

### 6. Nursing Course + Assessment Package
...
<!-- Original source page(s): 5 -->

### 8. Full Pharmacy OET Course
...
### 10. Full Crash Course - General OET
...
<!-- Original source page(s): 6 -->

### 11. Full Crash Course + 3 Writing Assessments
...
### 12. Full Crash Course + 5 Writing Assessments
...
Additional description-only website copy for the catalogue and product detail pages

This addendum contains the website descriptions for the AI grading packages, full mock packages, and separate Listening, Reading, Writing and Speaking packages shown in the platform screenshots.

## Key package logic used in this update

- Quick Check includes 5 flexible Writing/Speaking AI grading credits plus 3 Listening exams and 3 Reading exams.
- Exam Prep Pro includes 15 flexible Writing/Speaking AI grading credits plus 6 Listening exams and 6 Reading exams.
...
- Listening Pro and Reading Pro are the unlimited packages for their respective sub-tests.

<!-- Original source: second PDF, page 13 -->
...
**Best for:** Candidates who want the most complete AI-supported practice option with no fixed assessment limit during the access period.
...
- `OET_2026_Website_Course_Package_Descriptions_UPDATED (1).pdf`: pages 1-12, preserved in the consolidated catalogue.
- `OET_2026_Website_Course_Package_Descriptions_UPDATED_WITH_AI_PACKAGES (1).pdf`: pages 1-12 are text-identical to the first PDF and therefore appear once; pages 13-19 are preserved as the AI, practice and mock-exam addendum.
- Repeated running headers, footers and addendum page-number labels are consolidated rather than repeated after every source page.

<!--
Original repeated running header: OET with Dr. Ahmed Hesham | Website Course & Package Descriptions | 2026
Original repeated running footer: support@oetwithdrhesham.co.uk | app.oetwithdrhesham.co.uk
Original addendum page labels:
- AI, practice and mock exam package descriptions - Page 1
- AI, practice and mock exam package descriptions - Page 2
- AI, practice and mock exam package descriptions - Page 3
- AI, practice and mock exam package descriptions - Page 4
- AI, practice and mock exam package descriptions - Page 5
- AI, practice and mock exam package descriptions - Page 6
- AI, practice and mock exam package descriptions - Page 7
-->
