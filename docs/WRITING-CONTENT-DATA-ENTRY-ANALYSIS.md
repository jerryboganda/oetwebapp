...
| `WritingLessonsV2` | 48 | Starter/stub lesson content already seeded (code shipped with editable starter content, not final Dr Ahmed-approved material). Not in scope of "the writing folder" unless you want it reviewed separately. |
