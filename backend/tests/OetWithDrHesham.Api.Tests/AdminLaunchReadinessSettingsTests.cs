...
public sealed class AdminLaunchReadinessSettingsTests
{
    ...
    public async Task SystemAdmin_CanUpdateLaunchReadiness_AndPublicPolicyReadsIt()
    {
        ...
        var update = await client.PutAsJsonAsync("/v1/admin/launch-readiness/settings", new
        {
            ...
            iosAppStoreUrl = "https://apps.apple.com/app/oet-with-dr-hesham/id1234567890",
            androidPlayStoreUrl = "https://play.google.com/store/apps/details?id=com.oetwithdrhesham.learner",
        ...
        Assert.Equal("https://apps.apple.com/app/oet-with-dr-hesham/id1234567890", publicBody.RootElement.GetProperty("storeUrl").GetString());
    }
