...
public sealed class RuntimeSettingsProviderPathStructureTests
{
    ...
    public void OwnedRequestAndProviderPaths_ContainNoSyncWaitsOrContinuations()
    {
        ...
        var files = new List<string>
        {
            ...
            "backend/src/OetLearner.Api/Services/ExternalAuthService.cs",
            "backend/src/OetLearner.Api/Services/ExternalIdentityProviderClient.cs",
            "backend/src/OetLearner.Api/Services/PlatformLinkService.cs",
            "backend/src/OetLearner.Api/Services/Settings/RuntimeSettingsProvider.cs",
            ...
            "backend/src/OetLearner.Api/Services/Pronunciation/WhisperPronunciationAsrProvider.cs",
            "backend/src/OetLearner.Api/Services/Speaking/OpenAiWhisperSpeakingProvider.cs",
            "backend/src/OetLearner.Api/Services/Rulebook/AiProviderConnectionTester.cs",
            "backend/src/OetLearner.Api/Services/Reading/ReadingAttemptService.cs",
        };

        files.AddRange(EnumerateRelativeCsFiles(
            root,
            "backend/src/OetLearner.Api/Services/Conversation/Asr"));
        files.AddRange(EnumerateRelativeCsFiles(
            root,
            "backend/src/OetLearner.Api/Services/Conversation/Tts"));
