...
public static partial class SeedData
{
    ...
    public const string LearnerEmail = "learner@oet-with-dr-hesham.dev";
    public const string ExpertEmail = "expert@oet-with-dr-hesham.dev";
    public const string ExpertSecondaryEmail = "expert-unauthorised@oet-with-dr-hesham.dev";
    public const string AdminEmail = "admin@oet-with-dr-hesham.dev";
    ...
    private static void SeedContentPrograms(LearnerDbContext db)
    {
        ...
        db.ContentPrograms.Add(new ContentProgram
        {
            Id = "prg-foundation-basic-en", Code = "foundation-basic-en", Title = "Basic English for OET with Dr Heshamaration",
    ...
    private static void SeedStrategyGuides(LearnerDbContext db)
    {
        ...
        StrategyGuide Guide(
            ...
            => new()
            {
                ...
                SourceProvenance = "Original OET with Dr Hesham editorial content reviewed for learner guidance.",
                RightsStatus = "owned",
