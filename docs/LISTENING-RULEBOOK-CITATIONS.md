...
|R06.11|Unanswered-questions banner|Partial: [`app/listening/player/[id]/page.tsx`](../app/listening/player/[id]/page.tsx) has lock/submit confirmation copy; unanswered-number list remains pending|Pending dedicated route/E2E coverage|
|R07.3|Paper-mode final-review banner (last 2 min)|Partial: [`app/listening/player/[id]/page.tsx`](../app/listening/player/[id]/page.tsx) has current-section review banners; all-parts paper final-review parity remains pending|Pending paper-mode free-navigation/final-review coverage|
