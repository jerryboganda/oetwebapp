        ...
        <Popover.Root open={desktopOpen} onOpenChange={setDesktopOpen}>
          ...
          <Popover.Portal>
            <Popover.Content
              align="end"
              sideOffset={12}
              className="z-[100] w-[24rem] max-w-[calc(100vw-2rem)] origin-[var(--radix-popover-content-transform-origin)] rounded-2xl border border-border bg-surface p-4 shadow-2xl shadow-black/[0.12] data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-[0.97] data-[state=open]:slide-in-from-top-3 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-[0.97] duration-200"
            >
