...
public interface IDunningService
{
    ...
    /// the service computes the cadence from <see cref="OetWithDrHesham.Api.Domain.DunningAttempt"/>
    ...
    /// <summary>
    /// Wave A5 — execute the next pending <see cref="OetWithDrHesham.Api.Domain.DunningAttempt"/>
