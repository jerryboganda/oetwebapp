...
export const BILLING_COPY_FIELDS: BillingCopyField[] = [
  ...
  { key: 'billing.ai.description', section: 'AI packages', label: 'AI description', default: 'Credits grade your Writing letters and Speaking cards instantly with AI. 1 Writing letter or 1 Speaking card = 2 AI credits; a full two-card Speaking exam = 4 AI credits. Listening & Reading practice: the first part of a paper you open consumes 1 credit; the remaining parts of that same paper are free. Credits are deducted when grading starts and automatically refunded if grading fails.', multiline: true },
