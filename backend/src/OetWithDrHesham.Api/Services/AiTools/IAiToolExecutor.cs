...
namespace OetWithDrHesham.Api.Services.AiTools;
...
public interface IAiToolExecutor
{
    ...
    OetWithDrHesham.Api.Domain.AiToolCategory Category { get; }
...
public sealed record AiToolExecutionResult(
    OetWithDrHesham.Api.Domain.AiToolOutcome Outcome,
...
public sealed record AiToolDefinition(
    ...
    string Name,
    string Description,
    OetWithDrHesham.Api.Domain.AiToolCategory Category,
