...
using static OetWithDrHesham.Api.Services.PaymentGatewayJson;
...
public sealed class PaymentGatewayService : IPaymentGatewayProvider
{
    ...
    public PaymentGatewayService(
        ...
        OetWithDrHesham.Api.Services.Billing.Gateways.PayTabsGateway payTabs,
        OetWithDrHesham.Api.Services.Billing.Gateways.PaymobGateway paymob,
        OetWithDrHesham.Api.Services.Billing.Gateways.CheckoutComGateway checkoutCom,
        OetWithDrHesham.Api.Services.Billing.Gateways.EasyKashGateway easyKash)
    {
