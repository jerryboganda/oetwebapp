...
const EXAM_SECTIONS = [
  ...
  { icon: Mic, title: 'Speaking', duration: '~20 minutes', parts: '2 role-plays with an interlocutor', scoring: '5 criteria, 0–500 overall', tips: ['You have 2-3 minutes to prepare each role-play', 'Demonstrate clinical communication, not medical knowledge', 'Show empathy and active listening', 'Use appropriate tone for the clinical setting'] },
];
