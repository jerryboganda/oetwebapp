...
public class AiGatewayRecorderIntegrationTests
{
    ...
    /// <summary>
    /// Test stub for <see cref="OetWithDrHesham.Api.Services.AiManagement.IAiCreditService"/>
    ...
    /// </summary>
    private sealed class UnlimitedCreditStub : OetWithDrHesham.Api.Services.AiManagement.IAiCreditService
    {
        public Task<OetWithDrHesham.Api.Services.AiManagement.AiCreditBalance> GetBalanceAsync(string userId, CancellationToken ct)
            => Task.FromResult(new OetWithDrHesham.Api.Services.AiManagement.AiCreditBalance(
        ...
        public Task<bool> DebitUsageAsync(OetWithDrHesham.Api.Services.AiManagement.AiCreditUsageDebitRequest request, CancellationToken ct)
