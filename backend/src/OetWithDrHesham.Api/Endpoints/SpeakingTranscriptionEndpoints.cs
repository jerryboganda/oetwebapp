...
public static class SpeakingTranscriptionEndpoints
{
    public static IEndpointRouteBuilder MapSpeakingTranscriptionEndpoints(this WebApplication app)
    {
        ...
        app.MapGet("/v1/speaking/sessions/{sessionId}/tone", LearnerGetToneAsync)
            ...
            .Produces<OetWithDrHesham.Api.Services.Speaking.SpeakingToneResult>(StatusCodes.Status200OK)
            .Produces(StatusCodes.Status404NotFound);
    ...
    private static async Task<IResult> LearnerGetToneAsync(
        string sessionId,
        HttpContext http,
        OetWithDrHesham.Api.Services.Speaking.ISpeakingToneAssessor toneAssessor,
        LearnerDbContext db,
        CancellationToken ct)
    {
        ...
        if (session is null)
        {
            ...
            return Results.Ok((OetWithDrHesham.Api.Services.Speaking.SpeakingToneResult?)null);
        }
