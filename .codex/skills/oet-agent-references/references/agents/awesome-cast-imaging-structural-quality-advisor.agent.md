---
name: "Awesome cast-imaging-structural-quality-advisor"
...
**Tool sequence**: `quality_insights` â†’ `quality_insight_occurrences` â†’ `object_details` |
    â†’ `transactions_using_object`
