...
public static class ListeningPathwayEndpoints
{
    ...
    /// <summary>
    /// Lift a <see cref="OetWithDrHesham.Api.Domain.ListeningDailyPlanItem"/> into
    ...
    /// </summary>
    private static object ToPlanItemDto(OetWithDrHesham.Api.Domain.ListeningDailyPlanItem item)
    {
