...
describe('resolveApiBaseUrl', () => {
  ...
  it('prefers NEXT_PUBLIC_API_BASE_URL on the server when configured', async () => {
  ...
  it('uses the proxy path in the browser even when NEXT_PUBLIC_API_BASE_URL is configured', async () => {
