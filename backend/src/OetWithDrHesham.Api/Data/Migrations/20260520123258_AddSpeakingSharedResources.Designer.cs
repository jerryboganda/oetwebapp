...
namespace OetWithDrHesham.Api.Data.Migrations
{
    ...
    [Migration("20260520123258_AddSpeakingSharedResources")]
    partial class AddSpeakingSharedResources
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OetWithDrHesham.Api.Domain.AiAssistant.AiAuditEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OetWithDrHesham.Api.Domain.AiAssistant.AiChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OetWithDrHesham.Api.Domain.AiAssistant.AiChatThread", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AiChatThreads");
                });

            modelBuilder.Entity("OetWithDrHesham.Api.Domain.AiAssistant.AiCodebaseChunk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RepoRelativePath");

                    b.ToTable("AiCodebaseChunks");
                });

            modelBuilder.Entity("OetWithDrHesham.Api.Domain.AiAssistant.AiProviderConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OetWithDrHesham.Api.Domain.AiAssistant.AiRolePermissionMatrix", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("CanManageAssistant")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanReindex")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanRunCommands")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUseAssistant")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUseUnrestricted")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanWriteFiles")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("AiRolePermissionMatrix");
                });

            modelBuilder.Entity("OetWithDrHesham.Api.Domain.AiAssistant.AiToolInvocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool?>("ApprovalDecision")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("AiAssistantToolInvocations", (string)null);
                });

            modelBuilder.Entity("OetWithDrHesham.Api.Domain.AiAssistant.AiUsageLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OetWithDrHesham.Api.Domain.AiAssistant.AiChatMessage", b =>
                {
                    b.HasOne("OetWithDrHesham.Api.Domain.AiAssistant.AiChatThread", "Thread")
                        .WithMany("Messages")
