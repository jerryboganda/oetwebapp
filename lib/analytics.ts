...
const TRACKED_EVENTS = [
  ...
  'speaking_cbt_device_probe_result',
  ...
  'speaking_pdf_download_requested',
  'speaking_pdf_download_succeeded',
  'speaking_pdf_download_failed',
  // Marketplace events
  ...
  'peer_review_claimed',
  'peer_review_viewed',
  'peer_review_feedback_submitted',
  // Practice events
