...
name: "Awesome python-notebook-sample-builder"
...
- **Title cell** â€” One `#` heading with a concise title. One sentence describing what the reader will learn.
- **Setup cell** â€” Install dependencies (`%pip install ...`) and import libraries.
- **Section cells** â€” Each section has a short markdown intro followed by one or more code cells. Keep markdown crisp: 2-3 sentences max per cell.
- **Visualization cells** â€” Use pandas DataFrames for tabular data, matplotlib/seaborn for charts. Add titles and labels.
- **Wrap-up cell** â€” Summarize what was covered and suggest next steps or further reading.
