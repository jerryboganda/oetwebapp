...
public sealed class AiGatewayService(
    ...
    OetWithDrHesham.Api.Services.Settings.IRuntimeSettingsProvider? settingsProvider = null,
...
public sealed class RulebookPromptBuilder(IRulebookLoader loader)
{
    ...
    private static string RenderSystemPrompt(OetRulebook book, List<OetRule> applicable, AiGroundingContext ctx, int passMark, string passGrade)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("You are the AI assistant for the OET with Dr Heshamaration platform by Dr. Ahmed Hesham. Your knowledge about OET exam rules, grading, and feedback comes EXCLUSIVELY from the authoritative rulebook and scoring system reproduced below. Do not invent, extrapolate, or rely on outside opinions about OET.");
        sb.AppendLine();
