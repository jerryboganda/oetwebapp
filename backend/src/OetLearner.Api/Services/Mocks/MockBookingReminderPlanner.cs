...
public static class MockBookingReminderPlanner
{
    ...
    [
        ...
        new(TimeSpan.FromHours(2), NotificationEventKey.LearnerMockReminder1h, NotificationEventKey.ExpertMockReminder1h, "reminder-1h"),
        new(TimeSpan.FromMinutes(30), NotificationEventKey.LearnerMockReminder15m, NotificationEventKey.ExpertMockReminder15m, "reminder-15m"),
    ];
