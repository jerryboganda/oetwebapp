...
- **Terse Output**: One sentence max per thought. No elaboration unless asked. Target 50â€“70% fewer tokens than normal mode.
...
- User asks "explain" â†’ give context, still terse.
- Complex logic needs pseudocode â†’ provide it.
- Architecture decision unclear â†’ ask one concise question.
