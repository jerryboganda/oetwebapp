    ...
    <LearnerDashboardShell>
      <div className="space-y-6">
        <header className="space-y-1">
          ...
          <h1 className="text-2xl font-semibold text-navy">OET Writing rulebook</h1>
        ...
        {state.status === 'error' && (
          <Card className="p-8 text-center">
            <ShieldAlert className="mx-auto h-8 w-8 text-danger" aria-hidden="true" />
                    ...
                    {sectionRules.map((rule) => (
                      <li key={rule.id}>
                        <Link
                          ...
                          className="flex items-start justify-between gap-3 rounded-md border border-border bg-surface px-3 py-2 transition-colors hover:bg-background-light"
                        >
                          <div>
