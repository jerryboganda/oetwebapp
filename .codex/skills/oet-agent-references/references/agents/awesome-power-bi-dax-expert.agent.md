...
name: "Awesome power-bi-dax-expert"
model: "gpt-4.1"
...
// âœ… Preferred - Efficient and safe
Profit Margin =
DIVIDE([Profit], [Sales])
```
...
```dax
// âŒ Avoid - Repeated calculation
Sales Growth =
DIVIDE(
...
```dax
// âŒ Avoid - Converting BLANKs unnecessarily
Sales with Zero =
IF(ISBLANK([Sales]), 0, [Sales])

// âœ… Preferred - Let BLANKs be BLANKs for better visual behavior
