...
/**
 * Admin Select — Radix Select primitive matching shadcn-ui anatomy.
 *
 * Exports the full set so consumers can compose:
 * ```tsx
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      // disabled
      'disabled:cursor-not-allowed disabled:bg-[var(--admin-bg-subtle)]',
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown
        className="h-4 w-4 shrink-0 text-[var(--admin-fg-muted)] opacity-80"
        aria-hidden="true"
      />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-[var(--admin-state-hover)]',
      'data-[state=checked]:bg-[var(--admin-state-selected)]',
      'data-[state=checked]:text-[var(--admin-fg-strong)]',
      'data-[highlighted]:bg-[var(--admin-state-hover)]',
      'data-[highlighted]:text-[var(--admin-fg-strong)]',
      'data-[highlighted]:outline-none',
      // disabled
      'data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      // transitions
      'transition-colors duration-100 ease-[cubic-bezier(0.4,0,0.6,1)]',
      'motion-reduce:transition-none',
      className,
    )}
    {...props}
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <Check className="h-3.5 w-3.5 text-[var(--admin-primary)]" />
      </SelectPrimitive.ItemIndicator>
    </span>
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn(
      '-mx-1 my-1 h-px bg-[var(--admin-border)]',
      className,
    )}
    {...props}
  />
