...
public class AuthFlowsTests
{
    ...
    private static AuthServiceHarness CreateAuthServiceHarness()
    {
        ...
        var authOptions = Options.Create(new AuthTokenOptions
        {
            ...
            Audience = "oet-with-dr-hesham-web",
        ...
        var dataProtectionProvider = DataProtectionProvider.Create("OetWithDrHesham.Api.AuthServiceHarness");
    ...
    private sealed class JwtAuthApiWebApplicationFactory : WebApplicationFactory<Program>
    {
        ...
        public JwtAuthApiWebApplicationFactory(RecordingEmailSender sender, MutableTimeProvider timeProvider)
        {
            ...
            {
                ["ConnectionStrings:DefaultConnection"] = $"InMemory:oet-with-dr-hesham-auth-api-tests-{Guid.NewGuid():N}",
                ...
                ["Storage:LocalRootPath"] = Path.Combine(Path.GetTempPath(), $"oet-with-dr-hesham-auth-api-storage-{Guid.NewGuid():N}"),
                ["Proxy:TrustForwardHeaders"] = "false",
                ["Proxy:EnforceHttps"] = "false",
                ["AuthTokens:Issuer"] = "https://api.example.test",
                ["AuthTokens:Audience"] = "oet-with-dr-hesham-web",
                ...
                ["AuthTokens:AuthenticatorIssuer"] = "OET with Dr Hesham",
                ["Smtp:Enabled"] = "true",
                ...
                ["Smtp:FromName"] = "OET with Dr Hesham",
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                services.RemoveAll<OetWithDrHesham.Api.Services.Content.IUploadScanner>();
                services.AddSingleton(Sender);
                services.AddSingleton<IEmailSender>(Sender);
                services.AddSingleton<TimeProvider>(TimeProvider);
                services.AddSingleton<OetWithDrHesham.Api.Services.Content.IUploadScanner, TestCleanUploadScanner>();
            });
        }
    ...
    private sealed class TestCleanUploadScanner : OetWithDrHesham.Api.Services.Content.IUploadScanner
    {
