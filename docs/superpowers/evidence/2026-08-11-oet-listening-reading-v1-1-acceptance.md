...
| LR-13 | MCQ publication rejects zero/multiple correct options | `ListeningStructureService`, `ReadingStructureService`, explicit zero/multiple-correct authoring regression tests | Implemented; Reading cases passed in hosted run `31525852093`; Listening fixture mutation was corrected in `d1268602a`, rerun pending |
