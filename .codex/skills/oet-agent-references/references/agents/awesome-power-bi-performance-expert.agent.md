...
name: "Awesome power-bi-performance-expert"
model: "gpt-4.1"
...
âœ… Remove unnecessary columns and rows
âœ… Optimize data types (numeric over text)
âœ… Use calculated columns sparingly
âœ… Implement proper date tables
âœ… Disable auto date/time
...
âœ… Ensure proper indexing on source tables
âœ… Optimize database queries and views
âœ… Implement materialized views for complex calculations
âœ… Configure appropriate database maintenance

Model Design for DirectQuery:
âœ… Keep measures simple (avoid complex DAX)
âœ… Minimize calculated columns
âœ… Use relationships efficiently
âœ… Limit number of visuals per page
âœ… Apply filters early in query process
...
Variable Usage:
// âœ… Efficient - Single calculation stored in variable
...
// âœ… Efficient - Context transition minimized
Customer Ranking =
RANKX(
...
// âœ… Efficient - Proper use of iterator
...
âŒ Nested CALCULATE functions:
...
// âœ… Better - Single CALCULATE with multiple filters
Efficient Measure =
CALCULATE(
    SUM(Sales[Amount]),
    Product[Category] = "Electronics",
...
âŒ Excessive context transitions:
...
// âœ… Better - Pre-calculate or use relationships efficiently
Fast Calculation =
...
âœ… Minimize visuals on landing page
âœ… Use summary views with drill-through details
âœ… Implement progressive disclosure
âœ… Apply default filters to reduce data volume

Interaction Performance:
âœ… Optimize slicer queries
âœ… Use efficient cross-filtering
âœ… Minimize complex calculated visuals
âœ… Implement appropriate visual refresh strategies
...
Solutions:
âœ… Reduce visual count per page
âœ… Optimize DAX formulas
âœ… Implement appropriate filtering
âœ… Check network and capacity resources
...
Solutions:
âœ… Optimize DAX query patterns
âœ… Improve data source indexing
âœ… Increase capacity resources
âœ… Implement query optimization techniques
...
Solutions:
âœ… Implement data reduction techniques
âœ… Optimize model design
âœ… Use DirectQuery for large datasets
âœ… Scale capacity appropriately
```
