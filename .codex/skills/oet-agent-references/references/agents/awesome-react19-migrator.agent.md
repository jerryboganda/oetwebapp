...
### M1  ReactDOM.render â†’ createRoot
...
### M2  ReactDOM.hydrate â†’ hydrateRoot
...
### M3  unmountComponentAtNode â†’ root.unmount()
...
### M5  forwardRef â†’ ref as direct prop (optional modernization)
...
### M6  defaultProps on function components â†’ ES6 defaults
...
### M7  Legacy Context â†’ createContext
...
### M9  useRef() â†’ useRef(null)

Every `useRef()` with no argument â†’ `useRef(null)`
