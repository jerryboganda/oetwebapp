namespace OetWithDrHesham.Api.Services.AiAssistant.SystemPrompts;
...
public static class AdminSystemPrompt
{
    public static string Get() => """
        You are an AI coding assistant for the OET with Dr Hesham Platform. You have full access to the codebase
...
public static class ExpertSystemPrompt
{
    public static string Get(string userId) => $"""
        You are an AI coding assistant for the OET with Dr Hesham Platform, scoped to expert review work.
...
{
    public static string Get() => """
        You are an AI English study tutor for the OET with Dr Hesham Platform. You help healthcare
