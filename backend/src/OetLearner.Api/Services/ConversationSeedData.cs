...
public static class ConversationSeedData
{
    public static async Task EnsureAsync(LearnerDbContext db, CancellationToken ct = default)
    {
        ...
        db.ConversationTemplates.AddRange(BuildSeed(now));
    ...
    private static IEnumerable<ConversationTemplate> BuildSeed(DateTimeOffset now)
    {
        ...
        yield return T("oet-roleplay", "medicine", "medium",
            ...
            new[] { "Greet the patient warmly and confirm identity.", "Elicit ideas, concerns and expectations.", "Explain safe mobilisation, driving, and bathing limits in plain English.", "Address analgesia plan and warn about red-flag symptoms.", "Offer written information and close with a safety-net." },
        ...
        yield return T("oet-roleplay", "medicine", "medium",
            ...
            new[] { "Elicit patient's views about diabetes and medication.", "Explain diabetes and the role of metformin in plain English.", "Agree practical lifestyle goals (diet, activity, weight).", "Address side-effect concerns and adherence.", "Arrange follow-up and provide safety-netting." },
        ...
        yield return T("oet-roleplay", "medicine", "hard",
            "Breaking Bad News — Abnormal Mammogram",
            "Breast clinic, 46-year-old Ms Sarah Chen recalled after screening mammogram.",
            "You are the breast surgeon. Share that the mammogram showed a suspicious lesion requiring biopsy.",
            ...
            new[] { "Set up the conversation (private, unhurried).", "Elicit what the patient already understands.", "Give information in chunks with warning shot.", "Acknowledge and respond to emotion before facts.", "Agree a clear next step (biopsy, follow-up) and safety-net." },
        ...
        yield return T("oet-roleplay", "medicine", "easy",
            ...
            new[] { "Elicit concerns about statins.", "Explain cardiovascular risk and how statins reduce it.", "Discuss common and serious side-effects plainly.", "Agree a review date and safety-net for muscle symptoms." },
            new[] { "unexplained muscle pain", "dark urine (rhabdomyolysis)", "jaundice" },
            new[] { "cardiovascular risk", "LDL cholesterol", "myopathy" },
            new Dictionary<string, object?> { ["gender"] = "male", ["age"] = 59, ["accent"] = "en-GB", ["tone"] = "neutral" });

        yield return T("oet-handover", "medicine", "medium",
            ...
            new[] { "Identify yourself and the patient clearly.", "State the situation in one sentence.", "Summarise relevant background.", "Give your clinical assessment.", "Make a specific recommendation to the receiving team." },
        ...
        yield return T("oet-handover", "medicine", "hard",
            "Ward Handover: Post-op Sepsis Risk",
            "Surgical ward — shift handover.",
            "You are the outgoing registrar handing over to the on-call team.",
            ...
            new[] { "Lead with ISBAR framework.", "Highlight active problem (suspected sepsis).", "State obs trend and investigations pending.", "Give clear escalation triggers.", "Invite questions." },
            new[] { "rising NEWS", "lactate >2", "signs of septic shock" },
            new[] { "sepsis-6", "blood cultures", "lactate" },
            new Dictionary<string, object?> { ["gender"] = "male", ["age"] = 40, ["accent"] = "en-GB", ["tone"] = "neutral" });

        yield return T("oet-roleplay", "nursing", "medium",
            ...
            new[] { "Elicit her fears and what she can already manage.", "Explain her falls risk in simple language.", "Review medications with the patient.", "Suggest home adaptations and community support.", "Safety-net for red flags." },
        ...
        yield return T("oet-roleplay", "nursing", "easy",
            ...
            new[] { "Elicit the mother's specific concerns.", "Acknowledge her worry before giving information.", "Explain benefits of vaccination simply.", "Address common myths without being dismissive.", "Agree a plan that keeps the baby protected." },
            new[] { "signs of systemic illness post vaccine", "persistent high fever" },
            new[] { "herd immunity", "immunisation schedule" },
            new Dictionary<string, object?> { ["gender"] = "female", ["age"] = 29, ["accent"] = "en-GB", ["tone"] = "worried" });

        yield return T("oet-handover", "nursing", "medium",
            ...
            new[] { "Identify yourself, patient, location.", "State current situation.", "Summarise background.", "Give your nursing assessment.", "Recommend enhanced observation and delirium screen." },
            new[] { "desaturation", "aggression", "missed analgesia" },
            new[] { "delirium screen", "1:1 enhanced care", "ISBAR" },
            new Dictionary<string, object?> { ["gender"] = "female", ["age"] = 35, ["accent"] = "en-GB", ["tone"] = "neutral" });

        yield return T("oet-roleplay", "pharmacy", "medium",
            ...
            new[] { "Confirm indication and patient understanding.", "Explain INR monitoring and the yellow book.", "Discuss key interactions (alcohol, supplements, diet).", "Cover bleeding precautions and red flags.", "Offer written information and follow-up." },
            new[] { "unexplained bruising", "blood in urine/stool", "severe headache" },
            new[] { "INR", "target range", "vitamin K" },
            new Dictionary<string, object?> { ["gender"] = "male", ["age"] = 67, ["accent"] = "en-GB", ["tone"] = "neutral" });

        yield return T("oet-roleplay", "pharmacy", "easy",
            ...
            new[] { "Elicit current symptom pattern and belief about meds.", "Demonstrate correct technique.", "Explain the role of the preventer.", "Agree a short-term review plan.", "Safety-net for exacerbation." },
            new[] { "nocturnal symptoms", "peak flow drop", "reliever overuse" },
            new[] { "spacer", "ICS", "asthma action plan" },
            new Dictionary<string, object?> { ["gender"] = "female", ["age"] = 24, ["accent"] = "en-GB", ["tone"] = "skeptical" });

        yield return T("oet-roleplay", "physiotherapy", "medium",
            ...
            new[] { "Assess current range, strength and pain.", "Explain stages of ACL rehab in plain English.", "Negotiate return-to-sport timeline.", "Prescribe exercise progression.", "Safety-net for swelling/instability." },
        ...
        yield return T("oet-roleplay", "dentistry", "medium",
            ...
            new[] { "Explain diagnosis in plain English.", "Present options (RCT, extraction, no treatment).", "Discuss risks and recovery time.", "Address cost and work schedule concerns.", "Obtain documented consent and agree next step." },
            new[] { "increasing pain", "facial swelling", "fever" },
            new[] { "pulpitis", "irrigation", "obturation" },
