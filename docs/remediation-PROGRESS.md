...
| 6 | Fix encoding artifacts across affected files | Done | Fixed escaped quote rendering in `app/(auth)/terms/page.tsx` lead strings. Reverted JSX text to proper entities (React decodes these correctly in JSX text). No unicode corruption found. |
