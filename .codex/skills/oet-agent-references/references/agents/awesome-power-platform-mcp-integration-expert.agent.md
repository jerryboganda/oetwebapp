...
name: "Awesome power-platform-mcp-integration-expert"
model: GPT-4.1
...
- Tool and Resource architecture (âœ… Supported in Copilot Studio)
- Prompt architecture (âŒ Not yet supported in Copilot Studio, but prepare for future)
