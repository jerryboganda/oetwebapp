...
export const adminNavGroups: AdminNavGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        requiredPermissions: [AdminPermission.SecurityRead],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/admin/billing/storefront',
        label: 'Catalog Storefront',
        icon: <Store className={iconClassName} />,
        matchPrefix: '/admin/billing/storefront',
        requiredPermissions: [AdminPermission.BillingRead],
      },
      {
        href: '/admin/billing/subscriptions-packages',
        label: 'Subscriptions & Packages',
        icon: <Package className={iconClassName} />,
        matchPrefix: '/admin/billing/subscriptions-packages',
        requiredPermissions: [AdminPermission.BillingRead],
      },
      {
      ...
      {
        href: '/admin/billing/payment-methods',
        label: 'Payment Methods',
        icon: <CreditCard className={iconClassName} />,
        matchPrefix: '/admin/billing/payment-methods',
        requiredPermissions: [AdminPermission.BillingRead],
      },
      {
      ...
      },
      {
        ...
        icon: <CreditCard className={iconClassName} />,
        matchPrefix: '/admin/billing/stripe-accounts',
        requiredPermissions: [AdminPermission.BillingRead],
      },
      {
        href: '/admin/freeze',
...
const adminPageTitleRules: AdminPageTitleRule[] = [
  ...
  { prefix: '/admin/security', title: 'Security' },
