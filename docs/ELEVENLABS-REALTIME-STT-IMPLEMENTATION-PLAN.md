...
Conversation__ElevenLabsSttMaxConcurrentStreamsPerUser=1
Conversation__ElevenLabsSttMaxAudioSecondsPerSession=360
Conversation__ElevenLabsSttDailyAudioSecondsPerUser=<policy value>
