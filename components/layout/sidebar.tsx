...
// Admins have their own settings surface (/admin/settings, "Runtime Settings")
// inside the admin shell — routing them through the learner default here would
// bounce them out of the admin panel into the student-facing /settings page.
export function getWorkspaceSettingsHref(role?: UserRole | null): string {
  if (role === 'expert') return '/expert/settings';
