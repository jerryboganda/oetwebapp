    ...
    TimeProvider timeProvider)
{
    ...
    {
        var baseUrl = string.Equals(platform, "desktop", StringComparison.Ordinal) ? "oet-with-dr-hesham://" : ResolvePublicWebBaseUrl();
        ...
        // then exchanges it for a session. Desktop (oet-with-dr-hesham://) and mobile shells preserve fragments
