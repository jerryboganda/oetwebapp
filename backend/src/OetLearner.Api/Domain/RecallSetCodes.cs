...
/// and learners filtering by label should see it under each.
///
...
{
    /// <summary>Legacy practice collection label retained for persisted rows.</summary>
    public const string Old = "old";

    /// <summary>Practice collection label for January 2023 through end of 2025.</summary>
    public const string Y2023To2025 = "2023-2025";

    /// <summary>Practice collection label for January 2026 onwards.</summary>
    ...
    public static readonly IReadOnlyList<RecallSetMeta> Metadata = new[]
    {
        new RecallSetMeta(
            ...
            ShortLabel: "2026",
            Description: "Practice collection label for January 2026 onwards. This label is not source-backed unless term provenance explicitly says so.",
            SortOrder: 10),
        new RecallSetMeta(
            Code: Y2023To2025,
            DisplayName: "January 2023 → End of 2025",
            ShortLabel: "2023–2025",
            Description: "Practice collection label spanning 2023, 2024 and 2025. This label is not source-backed unless term provenance explicitly says so.",
            SortOrder: 20),
        new RecallSetMeta(
            Code: Old,
            DisplayName: "Old recalls + most common words",
            ShortLabel: "Classic",
            Description: "Legacy practice collection label for frequent OET vocabulary. This label is not source-backed unless term provenance explicitly says so.",
            SortOrder: 30),
    };
