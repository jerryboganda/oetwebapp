...
import CountryCodeSelect, {
  countryOptions,
} from "@/Component/CommonElements/CountryCodeSelect";
...
const SignUpBgImgPage = () => {
  ...
  const { examTypes, professions, sessions } = useEnrollmentTaxonomyStore();
  ...
  const filteredSessions = useMemo(
    ...
    [selectedExamTypeId, selectedProfessionId, sessions]
  );
  ...
  const handleSubmit = form.handleSubmit(async (values) => {
    ...
    const selectedSessionValue = sessions.find(
