...
echo '--- oetwebapp_oet_with_dr_hesham_storage ---'
du -sh /var/lib/docker/volumes/oetwebapp_oet_with_dr_hesham_storage/_data 2>&1
echo '--- oetwebsite_oet_with_dr_hesham_storage ---'
du -sh /var/lib/docker/volumes/oetwebsite_oet_with_dr_hesham_storage/_data 2>&1
echo '=== DONE ==='
