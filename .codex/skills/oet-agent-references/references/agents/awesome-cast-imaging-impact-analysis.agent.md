---
name: "Awesome cast-imaging-impact-analysis"
...
**Tool sequence**: `objects` â†’ `object_details` |
    â†’ `transactions_using_object` â†’ `inter_applications_dependencies` â†’ `inter_app_detailed_dependencies`
    â†’ `data_graphs_involving_object`
...
**Tool sequence**: `objects` â†’ `object_details` â†’ `transactions_using_object` â†’ `inter_applications_dependencies` â†’ `inter_app_detailed_dependencies`
...
**Tool sequences**: |
    â†’ `transactions_using_object` â†’ `transaction_details`
    â†’ `data_graphs_involving_object` â†’ `data_graph_details`
