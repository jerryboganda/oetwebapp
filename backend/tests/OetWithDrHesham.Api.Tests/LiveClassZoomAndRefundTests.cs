...
public sealed class LiveClassZoomAndRefundTests
{
    ...
    private sealed class ThrowingRuntimeSettingsProvider : OetWithDrHesham.Api.Services.Settings.IRuntimeSettingsProvider
    {
        public Task<OetWithDrHesham.Api.Services.Settings.EffectiveSettings> GetAsync(CancellationToken ct = default)
