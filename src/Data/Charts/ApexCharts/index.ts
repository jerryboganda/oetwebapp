import { generateHeatmapData, getLocalStorageItem, hexToRGB } from "@/_helper";
...
export const ApexChartsData = {
  ...
  ] as Array<Array<{ date: string; value: number }>>,
  seriesAreaChart: {
    monthDataSeries1: {
      prices: [
  ...
  ] as Array<{ name?: string; data: SeriesData }>,
  AdvanceTimeline: [
    {
      name: "Bob",
      data: [
  ...
  ] as Array<{ name: string; data: Array<{ x: Date; y: number[] }> }>,
  ...
  ] as Array<{ name: string; data: Array<{ x: string | number; y: number }> }>,
  BasicTreemapData: [
    {
      name: "Treemap",
      data: [
  ...
  ] as Array<{ name: string; data: TreemapDataPoint[] }>,
