            ...
            <div className="space-y-6">
              <ExpertRouteHero
                ...
                highlights={[
                  ...
                  { icon: CheckCircle2, label: 'Submission state', value: isReadOnly ? 'Locked' : 'Open' },
                ]}
                aside={<ExpertRouteFreshnessBadge value={detail.existingSubmission?.submittedAt ?? detail.createdAt} />}
              />
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <ExpertRouteSummaryCard
                  label="Submission"
                  value={isReadOnly ? 'Locked' : 'Open'}
                  hint={isReadOnly ? 'Submitted benchmark attempt and notes.' : 'Enter criterion-level scores using the benchmark rubric as your anchor.'}
                  accent={isReadOnly ? 'emerald' : 'amber'}
                  icon={CheckCircle2}
                />
              </div>
              ...
              <div className="grid grid-cols-1 gap-6 xl:grid-cols-[0.95fr_1.05fr]">
                ...
                <section className="space-y-4">
                  <ExpertRouteSectionHeader
                    ...
                    action={detail.existingSubmission ? <CheckCircle2 className="h-5 w-5 text-emerald-500" /> : <MessageSquare className="h-5 w-5 text-slate-400" />}
                  />
                  <Card className="border-slate-200 shadow-sm">
                    <CardContent className="space-y-4 p-5">
