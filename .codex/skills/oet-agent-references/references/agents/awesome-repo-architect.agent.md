...
PROJECT ROOT
â”‚
â”œâ”€â”€ [LAYER 1: FOUNDATION - System Context]
â”‚   "The Immutable Laws & Project DNA"
â”‚   â”œâ”€â”€ .github/copilot-instructions.md  â† VS Code reads this
â”‚   â””â”€â”€ AGENTS.md                         â† OpenCode CLI reads this
â”‚
â”œâ”€â”€ [LAYER 2: SPECIALISTS - Agents/Personas]
â”‚   "The Roles & Expertise"
â”‚   â”œâ”€â”€ .github/agents/*.agent.md        â† VS Code agent modes
â”‚   â””â”€â”€ .opencode/agents/*.agent.md      â† CLI bot personas
â”‚
â””â”€â”€ [LAYER 3: CAPABILITIES - Skills & Tools]
    "The Hands & Execution"
    â”œâ”€â”€ .github/skills/*.md              â† Complex workflows
    â”œâ”€â”€ .github/prompts/*.prompt.md      â† Quick reusable snippets
    â””â”€â”€ .github/instructions/*.instructions.md  â† Language/file-specific rules
```
...
2. **Create Directory Structure**
   ...
   â”œâ”€â”€ agents/
   â””â”€â”€ skills/ â†’ symlink to .github/skills/ (preferred)
...
4. **Generate Report**
   ```
   âœ… Structure Valid | âš ï¸ Warnings Found | âŒ Issues Found

   Foundation Layer:
     âœ… copilot-instructions.md (1,245 chars)
     âœ… AGENTS.md (symlink â†’ .github/copilot-instructions.md)

   Agents Layer:
     âœ… .github/agents/reviewer.md
     âš ï¸ .github/agents/architect.md - missing 'model' field

   Skills Layer:
     âœ… .github/skills/git-workflow.md
     âŒ .github/prompts/test-gen.prompt.md - missing 'description'
   ```
...
- `.cursor/` â†’ `.github/` (Cursor rules to Copilot)
- `.aider/` â†’ `.github/` + `.opencode/`
- Standalone `AGENTS.md` â†’ Full structure
- `.vscode/` settings â†’ Copilot instructions
...
ðŸ“¦ Suggested Collections:
  â€¢ typescript-mcp-development - MCP server patterns for TypeScript
  â€¢ frontend-web-dev - React, Vue, Angular best practices
  â€¢ testing-automation - Playwright, Jest patterns

ðŸ“„ Suggested Agents:
  â€¢ expert-react-frontend-engineer.agent.md
  â€¢ playwright-tester.agent.md

ðŸ“‹ Suggested Instructions:
...
Created:
  .github/
  â”œâ”€â”€ copilot-instructions.md (new)
  â”œâ”€â”€ agents/
  â”‚   â””â”€â”€ code-reviewer.agent.md (new)
  â”œâ”€â”€ instructions/
  â”‚   â””â”€â”€ typescript.instructions.md (new)
  â””â”€â”€ prompts/
      â””â”€â”€ test-gen.prompt.md (new)

  AGENTS.md â†’ symlink to .github/copilot-instructions.md
