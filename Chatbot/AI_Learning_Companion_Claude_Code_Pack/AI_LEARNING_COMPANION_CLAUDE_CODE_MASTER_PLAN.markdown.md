...
Do not claim “complete” until `scripts/validate_traceability.py` passes, every source requirement is mapped, and all in-scope acceptance evidence is attached or a deliberate blocked/deferred decision is documented.
