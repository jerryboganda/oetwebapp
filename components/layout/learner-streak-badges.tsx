    ...
    <div className={cn('flex items-center gap-1.5', className)}>
      ...
      {level !== null && (
        <Link
          ...
          className="flex items-center gap-1 rounded-full bg-navy px-2.5 py-1.5 text-xs font-bold text-surface shadow-sm ring-1 ring-border transition-colors hover:bg-navy/90"
        >
