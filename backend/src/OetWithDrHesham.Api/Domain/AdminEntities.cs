...
public class BillingPlan
{
    ...
    /// See <see cref="OetWithDrHesham.Api.Services.Entitlements.EffectiveEntitlementResolver"/>
    /// and <see cref="OetWithDrHesham.Api.Services.Speaking.SpeakingSessionService"/>.</summary>
