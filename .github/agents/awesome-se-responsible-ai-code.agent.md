---
name: "Awesome se-responsible-ai-code"
...
test_edge_cases = [
    "",              # Empty input
    "O'Brien",       # Apostrophe
    "JosÃ©-MarÃ­a",    # Hyphen + accent
    "X Ã† A-12",      # Special characters
]
```
...
<span style="color: red">âŒ Error: Invalid email</span> <!-- Good - icon + color -->
