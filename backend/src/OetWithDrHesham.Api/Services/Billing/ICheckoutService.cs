...
/// <see cref="OetWithDrHesham.Api.Domain.DeliveryMethods"/> — how the purchased package is handed
...
/// <see cref="OetWithDrHesham.Api.Domain.FulfilmentStatuses"/> for the subscription this order opened,
