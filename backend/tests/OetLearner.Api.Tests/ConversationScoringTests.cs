...
/// <summary>
/// Enforces the conversation scoring projection rules.
/// Anchor invariants come from docs/SCORING.md and
/// rulebooks/conversation/common/assessment-criteria.json.
/// </summary>
public class ConversationScoringTests
{
    ...
    {
        // Mission-critical: 4.2/6 == 70% of max == PASS anchor.
    ...
    public void Projection_Is_Monotonic()
    {
        ...
        for (var i = 0; i <= 60; i++)
        {
            ...
            Assert.True(scaled >= prev, $"mean={mean} scaled={scaled} prev={prev}");
            prev = scaled;
        }
    }
    ...
    public void ProjectedBand_Returns_Speaking_Result()
    {
        ...
        Assert.Equal("speaking", band.Subtest);
    }
