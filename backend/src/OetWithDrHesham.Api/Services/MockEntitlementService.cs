...
/// granted - consumed.
///
/// Premium subscribers (per <see cref="OetWithDrHesham.Api.Services.Entitlements.IEffectiveEntitlementResolver"/>)
...
public sealed class MockEntitlementService(
    LearnerDbContext db,
    OetWithDrHesham.Api.Services.Entitlements.IEffectiveEntitlementResolver entitlementResolver,
    ILogger<MockEntitlementService>? logger = null) : IMockEntitlementService
{
    ...
    private async Task<bool> HasUnlimitedMockSubscriptionAsync(
        OetWithDrHesham.Api.Services.Entitlements.EffectiveEntitlementSnapshot resolved,
        CancellationToken ct)
    {
        ...
        if (!resolved.IsModuleEnabled(OetWithDrHesham.Api.Services.Entitlements.ModuleKeys.Mocks)) return false;
    ...
    /// used by <see cref="OetWithDrHesham.Api.Services.Entitlements.EffectiveEntitlementResolver"/>.
    /// </summary>
