...
export interface ListeningPartBCAnswer {
  ...
  stem?: string | null;
  /** Option A/B/C or A/B/C/D text transcribed from the paper (null when unclear). */
  optionA?: string | null;
  optionB?: string | null;
  optionC?: string | null;
  optionD?: string | null;
 ...
 * both and returns the projected correct option (A/B/C or A/B/C/D) + a drafted rationale per
...
export function buildCanonicalListeningSkeleton(): ListeningAuthoredQuestion[] {
  ...
  const blank = (n: number, partCode: ListeningPartCode, type: ListeningQuestionType): ListeningAuthoredQuestion => ({
    ...
    type,
    stem: '',
    options: type === 'multiple_choice_3' ? ['', '', ''] : type === 'multiple_choice_4' ? ['', '', '', ''] : [],
    correctAnswer: '',
    acceptedAnswers: [],
    explanation: null,
    skillTag: null,
    ...
    points: 1,
    optionDistractorWhy: type === 'multiple_choice_3' ? [null, null, null] : type === 'multiple_choice_4' ? [null, null, null, null] : [],
    optionDistractorCategory: type === 'multiple_choice_3' ? [null, null, null] : type === 'multiple_choice_4' ? [null, null, null, null] : [],
