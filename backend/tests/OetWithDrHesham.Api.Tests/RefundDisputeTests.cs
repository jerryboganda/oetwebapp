...
public class RefundDisputeTests
{
        ...
        IPaymentGatewayProvider? gatewayProvider = null)
    {
        ...
        var gateways = new PaymentGatewayService(
            ...
            new OetWithDrHesham.Api.Services.Billing.Gateways.PayTabsGateway(new HttpClient(), billingOpts, TestRuntimeSettingsProvider.FromBillingOptions(billingOptions)),
            new OetWithDrHesham.Api.Services.Billing.Gateways.PaymobGateway(new HttpClient(), billingOpts, TestRuntimeSettingsProvider.FromBillingOptions(billingOptions)),
            new OetWithDrHesham.Api.Services.Billing.Gateways.CheckoutComGateway(new HttpClient(), billingOpts, TestRuntimeSettingsProvider.FromBillingOptions(billingOptions)),
            new OetWithDrHesham.Api.Services.Billing.Gateways.EasyKashGateway(new HttpClient(), billingOpts, TestRuntimeSettingsProvider.FromBillingOptions(billingOptions)));
    ...
    public async Task FullRefund_ReversesAiPackageCreditsAndLedgerBalance()
    {
        ...
        var balance = await new OetWithDrHesham.Api.Services.AiManagement.AiCreditService(db).GetBalanceAsync(userId, default);
