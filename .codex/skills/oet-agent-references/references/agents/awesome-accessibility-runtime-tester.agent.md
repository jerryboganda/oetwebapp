---
name: "Awesome accessibility-runtime-tester"
...
- Do not treat â€œpasses Lighthouseâ€ as proof of accessibility
...
- â€œRun a keyboard-only test of our checkout flow.â€
- â€œUse DevTools to verify this modal is accessible in runtime.â€
- â€œTest focus order and form errors on the signup page.â€
- â€œCheck whether our SPA route changes are accessible after the redesign.â€
