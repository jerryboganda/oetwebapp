...
const EXAM_SECTIONS = [
  { icon: Headphones, title: 'Listening', href: '/listening', duration: '~42 minutes', parts: 'Part A (consultation extract) + Part B (short workplace extracts)', scoring: '0–500 per subtest', tips: ['Listen for specific information and gist', 'Part A has one long dialogue, Part B has 6 short extracts', 'Read questions before audio plays'] },
  { icon: BookOpen, title: 'Reading', href: '/reading', duration: '60 minutes', parts: 'Part A (expeditious reading) + Part B (careful reading) + Part C (careful reading)', scoring: '0–500 per subtest', tips: ['Part A requires fast scanning of 3–4 texts', 'Part B tests understanding of a single text', 'Part C has 2 longer texts, so manage your time'] },
