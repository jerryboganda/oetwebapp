...
name: "Awesome research-technical-spike"
...
**Example**: For Microsoft technologies â†’ Microsoft Learn MCP server provides authoritative docs/APIs.
...
- Layer research: docs â†’ code examples â†’ real implementations â†’ edge cases
...
- `#search` â†’ `#fetch` â†’ `#githubRepo` (docs to implementation)
- `#githubRepo` â†’ `#search` â†’ `#fetch` (implementation to official docs)
