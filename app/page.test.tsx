...
describe('Dashboard page', () => {
  ...
  it('shows active subscription details in the dashboard hero', async () => {
    ...
    expect(screen.getByText('3 writing')).toBeInTheDocument();
    expect(screen.getByText('1 speaking')).toBeInTheDocument();
    expect(screen.getByText('5 AI credits')).toBeInTheDocument();
    expect(screen.getByText('Tutor Book')).toBeInTheDocument();
