...
| R-2026-09-14-PARITY-2 | 2026-09-14 | Android + iOS + Windows desktop | Android 1.4.14/9 · iOS 1.4.14/9 · Desktop 0.7.7 | `2ec46cd6` (tags point here) | `v1.4.14-mobile-android`, `v1.4.14-mobile-ios`, `v0.7.7-tauri-desktop` | **CI BLOCKED by GitHub Actions billing failure** — all runs for SHA `2ec46cd6` at 2026-09-14 14:11 UTC died at job creation, zero steps: desktop tag run `34854005712`, Build & Deploy `34853974318`, Mobile CI `34853974303` (mobile release must be dispatched after billing is restored per handover §4). | not built (blocked) | not published (blocked); pre-cut live state: Play internal+alpha 1.4.13/8, VPS android 1.4.13/8, iOS feed empty, desktop 0.7.6 | AutoCoder (OpenClaw) session |
