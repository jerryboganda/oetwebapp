...
public partial class LearnerDbContext(DbContextOptions<LearnerDbContext> options) : DbContext(options)
{
    ...
    public DbSet<OetWithDrHesham.Api.Domain.Classes.Tutor> Tutors => Set<OetWithDrHesham.Api.Domain.Classes.Tutor>();
    public DbSet<OetWithDrHesham.Api.Domain.Classes.TutorAvailability> TutorAvailabilities => Set<OetWithDrHesham.Api.Domain.Classes.TutorAvailability>();
    public DbSet<OetWithDrHesham.Api.Domain.Classes.ClassMaterial> ClassMaterials => Set<OetWithDrHesham.Api.Domain.Classes.ClassMaterial>();
    public DbSet<OetWithDrHesham.Api.Domain.Classes.ClassFeedback> ClassFeedbacks => Set<OetWithDrHesham.Api.Domain.Classes.ClassFeedback>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OetWithDrHesham.Api.Domain.Classes.Tutor>().Property(x => x.HourlyRateUsd).HasPrecision(10, 2);
        modelBuilder.Entity<OetWithDrHesham.Api.Domain.Classes.TutorAvailability>()
            .HasOne(x => x.Tutor)
