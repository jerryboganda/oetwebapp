...
/// rubric enforced by <see cref="OetWithDrHesham.Api.Services.OetScoring"/>.</summary>
...
/// through <see cref="OetWithDrHesham.Api.Services.OetScoring.SpeakingProjectedScaled(OetWithDrHesham.Api.Services.OetScoring.SpeakingCriterionScores)"/>
