...
const TRACKED_EVENTS = [
  ...
  'progress_subtest_toggled',
  'progress_chart_point_clicked',
  'progress_criterion_switched',
  'progress_tab_switched',
  'progress_pdf_exported',
  'plan_item_completed',
  'plan_item_skipped',
