...
**Key decision rule:** If it does async work or has side effects â†’ `componentDidUpdate`. If it's pure state derivation â†’ `getDerivedStateFromProps`.
...
## MIGRATION 5 - String Refs â†’ React.createRef()
...
## MIGRATION 6 - findDOMNode â†’ Direct Ref
...
## MIGRATION 7 - ReactDOM.render â†’ createRoot
