...
public static class WritingDrillV2Endpoints
{
    public static IEndpointRouteBuilder MapWritingDrillV2Endpoints(this IEndpointRouteBuilder app)
    {
            ...
            CancellationToken ct) =>
        {
            ...
            var result = await service.SubmitAttemptAsync(http.WritingV2UserId(), id, new OetLearner.Api.Services.Writing.WritingCaseNoteDrillAttemptRequest(responses, null), ct);
