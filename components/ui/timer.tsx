  ...
  return (
    <div
      className={cn(
        ...
        sizeStyles[size],
        isWarning ? 'bg-red-50 text-red-700 border border-red-200 dark:bg-red-950 dark:text-red-300 dark:border-red-800' : 'bg-background-light text-navy border border-border dark:text-white',
        className,
      )}
      role="timer"
