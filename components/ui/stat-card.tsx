...
export function StatCard({
  ...
  const toneMap = {
    default: {
      ...
      label: 'text-slate-700 dark:text-muted',
      ...
      trendNeutral: 'text-slate-700 dark:text-muted',
    ...
    success: {
      ...
      label: 'text-emerald-800 dark:text-success/70',
      iconFill: 'bg-success/20 dark:bg-success/20',
      iconText: 'text-success dark:text-success',
      trendUp: 'text-success dark:text-success',
      trendDown: 'text-danger dark:text-danger',
      trendNeutral: 'text-emerald-800 dark:text-success/60',
    ...
    warning: {
      ...
      label: 'text-amber-800 dark:text-warning/70',
      ...
      trendNeutral: 'text-amber-800 dark:text-warning/60',
    ...
    danger: {
      ...
      label: 'text-red-800 dark:text-danger/70',
      iconFill: 'bg-danger/20 dark:bg-danger/20',
      iconText: 'text-danger dark:text-danger',
      trendUp: 'text-danger dark:text-danger',
      trendDown: 'text-success dark:text-success',
      trendNeutral: 'text-red-800 dark:text-danger/60',
    ...
    info: {
      ...
      label: 'text-blue-800 dark:text-info/70',
      iconFill: 'bg-info/20 dark:bg-info/20',
      iconText: 'text-info dark:text-info',
      trendUp: 'text-success dark:text-success',
      trendDown: 'text-danger dark:text-danger',
      trendNeutral: 'text-blue-800 dark:text-info/60',
