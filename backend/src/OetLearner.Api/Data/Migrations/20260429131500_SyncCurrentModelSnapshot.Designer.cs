...
namespace OetLearner.Api.Data.Migrations
{
    ...
    [Migration("20260429131500_SyncCurrentModelSnapshot")]
    partial class SyncCurrentModelSnapshot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.BillingOperation", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasIndex("OperationType", "Status", "CreatedAt");

                    b.HasIndex("UserId", "Status", "CreatedAt");

                    b.ToTable("BillingOperations");
                });
