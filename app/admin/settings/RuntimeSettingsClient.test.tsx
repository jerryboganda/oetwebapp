...
function makeResponse(overrides: Partial<RuntimeSettingsResponse> = {}): RuntimeSettingsResponse {
  return {
    email: {
      ...
      authFromAddress: 'auth@oetwithdrhesham.co.uk',
      authFromName: 'Auth | OET with Dr Hesham',
      marketingFromAddress: 'updates@oetwithdrhesham.co.uk',
      marketingFromName: 'Updates | OET with Dr Hesham',
      productFromAddress: 'no-reply@oetwithdrhesham.co.uk',
      productFromName: 'No-reply | OET with Dr Hesham',
      supportFromAddress: 'support@oetwithdrhesham.co.uk',
      supportFromName: 'OET with Dr. Ahmed Hesham',
