...
| LR-13 | MCQ publication rejects duplicate options and zero/multiple correct options | `ListeningStructureService`, `ReadingStructureService`, explicit duplicate/zero/multiple-correct authoring regression tests | Implemented; focused execution pending after duplicate-option guard addition |
