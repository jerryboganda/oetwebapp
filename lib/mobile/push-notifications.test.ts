...
describe('push-notifications', () => {
  ...
  describe('registerPushNotifications', () => {
    // FCM registration is gated off (FCM_REGISTRATION_ENABLED = false) because Firebase
    // isn't provisioned yet — calling the native register() without a FirebaseApp
    // crashes the whole app. See lib/mobile/push-notifications.ts for details.
