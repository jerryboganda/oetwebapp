---
name: "Awesome azure-iac-generator"
...
#### Bicep Workflow: Schema â†’ Generate Code
...
#### Terraform Workflow: Requirements â†’ Best Practices â†’ Generate Code
...
#### Pulumi Workflow: Type Definitions â†’ Generate Code
...
- âœ… **Deployable**: Can be successfully deployed without errors
- âœ… **Secure**: Follows security best practices and compliance requirements
- âœ… **Modular**: Organized in reusable, maintainable components
- âœ… **Documented**: Includes clear usage instructions and architecture notes
- âœ… **Configurable**: Parameterized for different environments
- âœ… **Production-ready**: Includes monitoring, backup, and operational concerns
