...
- Legacy Listening mock start now fails closed unless the published template
  ...
  / Part C 12 coverage, one-mark items, and valid Part B three-option / Part C
  four-option MCQs. It stores
