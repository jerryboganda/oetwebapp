...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.AiPackageCreditAccount", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<bool>("ExpiredBecausePassed")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.AiPackageCreditTransaction", b =>
                {
                    ...
                    b.Property<int>("ListeningTestsDelta")
                        .HasColumnType("integer");

                    b.Property<int>("MockExamsDelta")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ReadingTestsDelta")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("WritingOnlyCreditsDelta")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.BillingAddOn", b =>
                {
                    ...
                    b.Property<string>("AiFeaturesJson")
                        .IsRequired()
                        .HasMaxLength(4096)
                        .HasColumnType("character varying(4096)");

                    b.Property<string>("AiPackageGroup")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.BillingContentString", b =>
                {
                    ...
                    b.ToTable("BillingContentStrings");
                });
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.LearnerExamOutcome", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<string>("RecordedByAdminId")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("RecordedByAdminName")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.ManualPaymentRequest", b =>
                {
                    ...
                    b.Property<string>("CandidateWhatsApp")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.MaterialFile", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.MaterialFolder", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.MaterialFolderAudience", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.ReadingPaperAnnotation", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.ReadingSection", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.SpeakingResultVisibilityConfig", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.Subscription", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FrozenSince")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int>("MaxFreezeDaysAllowed")
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTimeOffset?>("PendingFreezeRequestDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int?>("PreservedRemainingDays")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.SubscriptionFreeze", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("AdminDecisionById")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<DateTimeOffset?>("AdminDecisionDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTimeOffset?>("FreezeEndDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTimeOffset>("FreezeRequestDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("FreezeStartDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int?>("PreservedRemainingDaysAtFreeze")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.MaterialFile", b =>
                {
                    b.HasOne("OetLearner.Api.Domain.MaterialFolder", "Folder")
                        .WithMany()
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.MaterialFolder", b =>
                {
                    b.HasOne("OetLearner.Api.Domain.MaterialFolder", "ParentFolder")
                        .WithMany()
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.ReadingPaperAnnotation", b =>
                {
                    b.HasOne("OetLearner.Api.Domain.ContentPaperAsset", "ContentPaperAsset")
                        .WithMany()
            ...
            modelBuilder.Entity("OetLearner.Api.Domain.ReadingQuestion", b =>
                {
                    ...
                    b.HasOne("OetLearner.Api.Domain.ReadingSection", "Section")
                        .WithMany("Questions")
