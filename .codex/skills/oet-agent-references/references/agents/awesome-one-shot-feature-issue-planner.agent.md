...
name: "Awesome one-shot-feature-issue-planner"
agent: agent
...
- Avoid vague phrases like â€œhandle appropriatelyâ€ or â€œupdate as neededâ€.
- Prefer concrete statements such as:
  - â€œAdd validation to `src/api/orders.ts` before persistenceâ€
  - â€œCreate integration tests for the unauthorized flowâ€
  - â€œEmit analytics event on successful submissionâ€
