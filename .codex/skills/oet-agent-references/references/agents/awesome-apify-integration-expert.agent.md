---
name: "Awesome apify-integration-expert"
...
- `fetch-actor-details`: Get detailed info about an Actorâ€”what inputs it accepts, what outputs it produces, pricing, etc.
