...
public class RecallsContentSeederTests
{
    ...
    private static string FindApiProjectRoot()
    {
        ...
        while (current is not null)
        {
            ...
            var repoRelative = Path.Combine(current.FullName, "backend", "src", "OetWithDrHesham.Api", "Data", "SeedData", "recalls");
        ...
        throw new DirectoryNotFoundException("Could not locate OetWithDrHesham.Api recall seed folder.");
    }
