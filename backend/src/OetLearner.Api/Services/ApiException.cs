...
public sealed class ApiException : Exception
{
    ...
    public static ApiException ServiceUnavailable(string errorCode, string message, bool retryable = true)
        => new(StatusCodes.Status503ServiceUnavailable, errorCode, message, retryable: retryable);
}
